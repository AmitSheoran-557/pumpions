...
const OgPumpions = () => {
    return (
        <div id='team' className='w-full flex justify-center bg-dark-green-2 items-center -mt-1'>
                    ...
                    >
                        {OG_PUMPIONS_DATA_LIST.map((item, index) => (
                            <SwiperSlide key={index} className="flex flex-col items-center">
                                <Image className="w-full mb-[15px]" src={item.image} width={226} height={208} alt="card-img" />
