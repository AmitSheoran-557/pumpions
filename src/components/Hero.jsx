...
const Hero = () => {
    return (
        <div className='bg-[url("/assets/images/webp/hero-bg.webp")] overflow-hidden bg-cover bg-center w-full flex flex-col items-center justify-center relative'>
            <Header />
            <Image className="lg:max-w-[166px] hero-img-1 absolute top-44 left-0 pointer-events-none w-full" src="/assets/images/webp/hero-cloud-img-1.webp" width={166} height={85} alt="hero-cloud-img-1" />
            <Image className="lg:max-w-[152px] hero-img-2 absolute top-36 right-0 pointer-events-none w-full" src="/assets/images/webp/hero-cloud-img-2.webp" width={152} height={65} alt="hero-cloud-img-2" />

            <div className="max-[1660px]:max-w-[1920px] xl:max-w-[1204px] lg:max-w-[992px] md:max-w-[768px] max-w-[375px] mx-auto px-8 z-20 relative">
